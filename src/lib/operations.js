...
export const demoFinancingRequests = [
  {
    ...
    bankApplication: { provider: "RichGreen Microfinance Bank", externalReference: "Pending", status: "Manual handoff" },
  ...
  },
  {
    ...
    bankApplication: { provider: "LOTUS Bank", externalReference: "Pending", status: "Ready for handoff" },
  ...
  },
  {
    ...
    bankApplication: { provider: "RichGreen Microfinance Bank", externalReference: "Pending", status: "locked-pending-customer-approval", redirectUrl: "" },
  ...
  },
  {
    ...
    bankApplication: { provider: "LOTUS Bank", externalReference: "Pending", status: "awaiting-bank-link", redirectUrl: "" },
...
export const demoProjectDocuments = [
  ...
  },
  {
    ...
    total: 10680000,
    equityPercentage: 10,
    equityAmount: 1068000,
    bankFinanceAmount: 9612000,
    terms: "Approved by the customer. LOTUS Bank application link pending. The customer equity contribution is 10% of the approved total project cost.",
